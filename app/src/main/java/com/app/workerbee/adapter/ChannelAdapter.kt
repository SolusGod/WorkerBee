...
import com.app.workerbee.databinding.ItemChannelBinding
...
class ChannelAdapter(
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemChannelBinding.inflate(LayoutInflater.from(viewGroup.context), viewGroup, false)
    ...
    inner class ViewHolder(private val binding: ItemChannelBinding) :
        ...
        fun bind(obj: ChannelModel) {
            binding.titleTextView.text = Utils.checkNull(obj.snippet?.title)
            Utils.loadImage(mContext, Utils.checkNull(obj.snippet?.thumbnails?.medium?.url), binding.imageView)
