...
public class MyPreferences {
    ...
    public MyPreferences(Context appContext) {
    ...
    private String setupFullPath(String imageName) {
        File mFolder = new File(context.getExternalFilesDir(null), DEFAULT_APP_IMAGE_DATA_DIRECTORY);
    ...
    //User Class
    public ChannelModel getChannelData(String key) {

        Gson gson = new Gson();
        String objStrings = getString(key);
        return gson.fromJson(objStrings, ChannelModel.class);
    }
...
//    }
    ...
    public ArrayList<ChannelModel> getChannelList(String key, Class<ChannelModel> mClass) {

        Gson gson = new Gson();
        ArrayList<String> objStrings = getListString(key);
        ArrayList<ChannelModel> objects = new ArrayList<>();

        for (String jObjString : objStrings) {
            ChannelModel value = gson.fromJson(jObjString, mClass);
            objects.add(value);
        }
        return objects;
    }

    public void putChannelList(String key, ArrayList<ChannelModel> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
